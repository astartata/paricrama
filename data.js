...
window.PARIKRAMA_DATA={
 guests:[
  {name:'Max Mari',spirit:'Махирадха',gender:'Матаджи',city:'Москва',country:'Россия',tariff:'Премиум 2-местный',room:'',advance:'',remainder:'',refusal:true},
  {name:'Ivanov Ivan',spirit:'Атма д',gender:'Прабху',city:'Москва',country:'Россия',tariff:'Премиум 2-местный',room:'01_SRSK',advance:'24.11.2026',remainder:'',refusal:false},
  {name:'Verkhotina Tatiana',spirit:'',gender:'Матаджи',city:'Москва',country:'Россия',tariff:'Комфорт+ 2-местный',room:'',advance:'13.11.2026',remainder:'',refusal:false},
  {name:'Inty Ghers',spirit:'',gender:'Прабху',city:'',country:'',tariff:'Премиум 2-местный',room:'02_SRSK',advance:'',remainder:'',refusal:false},
  {name:'П,п псеме',spirit:'Параметрам прабху',gender:'Прабху',city:'',country:'',tariff:'',room:'',advance:'',remainder:'',refusal:false}
 ],
 rooms:[
 ...
 payments:[{date:'13.11.2026',name:'Verkhotina Tatiana, Verkhotina Olga',amount:32000,currency:'Рубль',receipt:'https://drive.google.com/open?id=1f0HJhMvIzru-b9WRyOnmn6AVS1aOfxaC',comment:'dfghjk'}],
 children:[{parent:'Verkhotina Tatiana',childName:'Verkhotina Olga',age:12,tariff:'Комфорт+ 2-местный',room:'',paid:'13.11.2026'}],
